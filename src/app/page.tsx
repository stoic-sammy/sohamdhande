      ...
      <div className="space-y-6">
        <div>
          <h4 className="font-bold text-xl">
            Consultant <span className="text-black/60">@ Freelancing</span>
          </h4>
        ...
        <div>
          <h4 className="font-bold text-xl">
            Consultant <span className="text-black/60">@ Deloitte</span>
          </h4>
        ...
        <div>
          <h4 className="font-bold text-xl">
            DevOps Intern <span className="text-black/60">@ Expert Cloud Consulting</span>
          </h4>
        ...
        <div>
          <h4 className="font-bold text-xl">
            Cyber Security Analyst <span className="text-black/60">@ Coditing</span>
          </h4>
      ...
      <div className="space-y-4">
        <div>
          <h4 className="font-bold text-lg">
            Cloud Audits (TPRM){' '}
            <span className="text-sm text-black/40">IT Sector</span>
          </h4>
          <p className="text-lg text-black/70">
            Comprehensive third-party risk management audits for cloud infrastructure.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-lg">
            Project Management <span className="text-sm text-black/40">BFSI Sector</span>
          </h4>
          <p className="text-lg text-black/70">
            Led project management initiatives in banking and financial services.
          </p>
        </div>
        <div>
          <h4 className="font-bold text-lg">
            Third Party Risk Management{' '}
            <span className="text-sm text-black/40">BFSI Sector</span>
          </h4>
          <p className="text-lg text-black/70">
            Implemented comprehensive TPRM frameworks for financial institutions.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="w-full flex flex-col md:flex-row gap-8 items-start justify-center">
        <div className="flex-1 flex flex-col items-center md:items-start space-y-4">
          ...
          <div className="flex flex-col gap-2 text-black/80 items-center md:items-start text-lg font-semibold">
            <a href="mailto:sohamdhande11@gmail.com" className="hover:underline">
              sohamdhande11@gmail.com
            </a>
            <span>📞 +91 7559444529</span>
            <a
              href="https://www.linkedin.com/in/sohamdhande"
              target="_blank"
